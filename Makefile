...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Jun 7 20:36:13 2018
# Project:  music.pro
# Template: app
# Command: /opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/qmake -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile music.pro
#############################################################################
...
Makefile: music.pro  /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++/qmake.conf /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/linux.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base-unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -o Makefile music.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/music1.0.0 || $(MKDIR) .tmp/music1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/music1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/music1.0.0/ && $(COPY_FILE) --parents src.qrc .tmp/music1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/music1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/music1.0.0/ && (cd `dirname .tmp/music1.0.0` && $(TAR) music1.0.0.tar music1.0.0 && $(COMPRESS) music1.0.0.tar) && $(MOVE) `dirname .tmp/music1.0.0`/music1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/music1.0.0
...
qrc_src.cpp: src.qrc \
		...
		resource/play.png \
		resource/ba.jpg
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/rcc -name src src.qrc -o qrc_src.cpp
